...
# Perform tests
####
run "fetch_billing_service_account" {
  state_key = "main"
  ...
  assert {
    condition     = data.aws_billing_service_account.this.arn != ""
    error_message = "Expected billing service account ARN to be non-empty."
  }
}
