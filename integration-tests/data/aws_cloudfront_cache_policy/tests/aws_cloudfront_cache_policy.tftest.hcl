...
run "fetch_cache_policy" {
  ...
  assert {
    condition     = data.aws_cloudfront_cache_policy.this.name == "Managed-CachingOptimized"
    error_message = "Expected cache policy name to be Managed-CachingOptimized."
  }
}
